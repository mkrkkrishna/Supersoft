...
<body class="header-fixed" style="padding: 0; margin: 0; font-family: Arial, Verdana; background-color: #fff;">
...
<div class="jumbotron outer" style="border:0px solid #0099FF;border-radius:11px;box-shadow: 0px 0px 20px #888888;float: left;width: 100%;margin-top:3%;position:relative;left:5%;">
...
<c:if test="${!empty listContactUs}">
	<c:forEach items="${listContactUs}" var="listContactUs">
		<div class="hover child" style="width:90%;border:1px solid lightgray;margin-top:3%;height:70px;margin-left:3%;">
			<div style="height:31px;width:80%;overflow-y: hidden;overflow-x: hidden;">
				<a style="padding:2%;width:30%;override:hidden;font-size:150%;color:gray;" href="${pageContext.request.contextPath}/contactUsDetails/${listContactUs.contactId}">${listContactUs.contactText}</a>
				<a style="font-size:90%;color:red;" href="${pageContext.request.contextPath}/contactUsDetails/${listContactUs.contactId}">Read More</a>
			</div>
			<p style="color:gray;padding-left:2%;font-size:110%;">
				${listContactUs.contactName}<span style="float:right;">${listContactUs.contectNumber}</span>
			</p>
		</div>
	</c:forEach>
</c:if>
...
<div id="contact" style="margin-top:2%;postion:relative;">
